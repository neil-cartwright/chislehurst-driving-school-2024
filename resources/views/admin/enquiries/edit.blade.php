...
@section('main')
    ...
    <nav class="breadcrumb has-bullet-separator" aria-label="breadcrumbs">
        <ul>
            ...
            <li class="is-active"><a>Edit an enquiry</a></li>
        </ul>
    </nav>
    <x-wrapper>
        <!-- columns -->
        <x-admin.columns>
            ...
            @endif
            <x-card>
                <x-slot:title>Edit enquiry
                </x-slot:title>
                <x-slot:content>
                    <form action="/admin/enquiry/update/{{ $enquiry->id }}" method="POST">
                        @csrf
                        ...
                        <div class="field w-half">
                            ...
                            <div class="control is-flex-grow-0">
                                <input type="email" name="email" class="input" id="email"
                                    placeholder="davefisher@dave.com" value="{{ $enquiry->email }}" />
                            </div>
                        </div>
                        ...
                        <div class="field w-half">
                            ...
                            <div class="control is-flex-grow-0">
                                <input type="tel" name="tel" class="input" id="tel"
                                    value="{{ $enquiry->tel }}" placeholder="07917 042 740" />
                            </div>
                        </div>
                        ...
                        <div class="field w-half">
                            ...
                            <div class="control is-flex-grow-0">
                                <input type="text" name="address" class="input" id="address"
                                    value="{{ $enquiry->address }}" placeholder="10 Dacre Park BR7 5FP" />
                            </div>
                        </div>
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <textarea class="textarea" placeholder="Message" name="message" value="{{ $enquiry->message }}"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="is-flex">
                            <div class="field w-half">
                                ...
                                <div class="control">
                                    <div class="select">
                                        <select name="type" value="{{ $enquiry->type }}">
                            ...
                            <div class="field w-half">
                                ...
                                <div class="control">
                                    <div class="select">
                                        <select name="outcome" value="{{ $enquiry->outcome }}">
