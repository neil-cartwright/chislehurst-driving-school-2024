    ...
    >
        <div class="card">
            <header class="card-header">
                <div class="card-header-title">Save a Lesson</div>
            </header>
                    ...
                    >
                        ...
                        >
                            ...
                            <input
                                ...
                                ref="amountTaken"
                                v-model="formData.amountPaymentTaken"
                            />
                        </div>
                    </div>
                </div>
...
const formData = ref({
    ...
    paymentTaken: 0,
    discountGiven: 0,
    amountPaymentTaken: 0,
    lesson_cancelled: 0,
    paid_cash: 0,
});

/* populate full customer object when formData is updated */
watch(formData.value, () => {
    props.customers.forEach((x) => {
        if (x.id == formData.value.customer_id) {
            customer.value = x;
        }
    });
});
...
const checkParams = () => {
    ...
    if (id) {
        return (formData.value.customer_id = id);
    }
};

const handleSubmit = () => {
    if (formData.value.customer_id != 0) {
        axios
            .post("/admin/lesson/store", formData.value, {
                headers: {
