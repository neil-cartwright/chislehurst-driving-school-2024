var questions = [
...

    {
        ...
        explanation:
            "This sign may prevent you from driving the wrong way down a one-way street",
    },

    {
        ...
        alt: "one way street",
        question:
            "When turning right from a one way street, where should you position the car?",
        answers: [
        ...
        explanation:
            "You should position the car to the right of the road, unless signs say otherwise. This allows traffic turning left or going ahead to pass you on your left.",
    },

    {
        ...
        explanation:
            "Some one way systems allow cyclists and buses to travel against the flow of the other vehicles",
    },

    {
        ...
        alt: "one way systems",
        question:
            "True or False. You may overtake on the left when on a one-way street?",
        answers: [
            { val: null, correct: true, answer: "True" },
            { val: null, correct: false, answer: "False" },
        ],
        explanation:
            "You may overtake on the left if you are on a one-way street",
    },
    {
        ...
        answers: [
            {
                val: null,
                correct: false,
                answer: "Priority over oncoming traffic",
            },
            {
                val: null,
                correct: true,
                answer: "No priority over oncoming traffic",
            },
            { val: null, correct: false, answer: "One Way street" },
        ],
        explanation:
            "You will see this near traffic calming, where only one vehicle may pass",
    },
    {
        imgSrc: "/img/driving-images/warning-signs/two-way-traffic-crossing.jpg",
        alt: "two way traffic",
        question: "What does this sign mean?",
        answers: [
            {
                val: null,
                correct: false,
                answer: "No-one has priority",
            },
            {
                val: null,
                correct: true,
                answer: "Warning: Two way traffic",
            },
            { val: null, correct: false, answer: "Warning: Dual carriageway" },
        ],
        explanation:
            "You might see this sign at the junction of a one-way street, warning of two way traffic",
    },
];
